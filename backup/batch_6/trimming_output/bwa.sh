...
bwa mem -M -t 4 /data/SBCS-BuggsLab/GabrieleNocchi/bwa_index/Qrob_PM1N.fa $INPUT1 $INPUT2 > /data/SBCS-BuggsLab/GabrieleNocchi/Oak/batch_6/bwa_output/$OUTPUT\.sam

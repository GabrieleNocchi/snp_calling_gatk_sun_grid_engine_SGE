...
INPUT1=$(sed -n "${SGE_TASK_ID}p" ./files1.txt)
INPUT2=$(sed -n "${SGE_TASK_ID}p" ./files2.txt)
OUTPUT1=$(sed -n "${SGE_TASK_ID}p" ./files3.txt)
OUTPUT2=$(sed -n "${SGE_TASK_ID}p" ./files4.txt)
